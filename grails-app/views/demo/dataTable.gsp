...
<script src="${resource(dir: 'js/uncompressed', file: 'jquery.dataTables.js')}"></script>
<script src="${resource(dir: 'js/compressed', file: 'jquery.dataTables.bootstrap.js')}"></script>
