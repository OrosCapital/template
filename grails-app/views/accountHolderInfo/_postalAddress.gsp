    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="col-sm-7" placeholder="Contact Person Name" id="postalContactPersonName"
                       name="postalContactPersonName">
            </div>

            <div class="form-group">
                <label for="postalAddressLine1" class="col-sm-5 control-label">Postal Address Line1</label>
                <textarea class="col-sm-7" placeholder="First Postal Address" id="postalAddressLine1"
                          name="postalAddressLine1"></textarea>
            </div>

            <div class="form-group">
                <label for="postalCity" class="col-sm-5 control-label">Postal City</label>
                <input type="text" class="col-sm-7" placeholder="Postal City" id="postalCity"
                       name="postalCity">
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="col-sm-7" placeholder="Postal Postcode" id="postalPostcode"
                       name="postalPostcode">
            </div>

            <div class="form-group">
                <label for="postalAddressLine2" class="col-sm-5 control-label">Postal Address Line2</label>
                <textarea class="col-sm-7" placeholder="Second Postal Address" id="postalAddressLine2"
                          name="postalAddressLine2"></textarea>
            </div>

            <div class="form-group">
                <label for="postalState" class="col-sm-5 control-label">Postal State</label>
                <input type="text" class="col-sm-7" placeholder="Postal State" id="postalState"
                       name="postalState">
            </div>
