        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="col-xs-10 col-sm-12" placeholder="Bank Account Name"
                       id="bankAccountName" name="bankAccountName" required="required">
            </div>
        </div>
        <div class="form-group">
            <label for="status"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="col-xs-10 col-sm-12" placeholder="Iban Prefix"
                       id="ibanPrefix" name="ibanPrefix" required="required">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input type="text" class="col-xs-10 col-sm-12" placeholder="Bank Account Number"
                       id="bankAccountNo" name="bankAccountNo" required="required">
            </div>
        </div>
    </div><!-- /.col -->
</div>
